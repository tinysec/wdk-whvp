...
#pragma warning(disable:4116) /* unnamed type definition in parentheses (generated by TYPE_ALIGNMENT) */
#endif
...
typedef enum WHV_REGISTER_NAME
{
    ...
    WHvArm64RegisterSmcrEl1           = 0x0004005D,
    WHvArm64RegisterSmidrEl1          = 0x0004005F,
    WHvArm64RegisterSmpriEl1          = 0x00040060,
    WHvArm64RegisterSvcr              = 0x00040082,
    WHvArm64RegisterTcrEl1            = 0x00040007,
    WHvArm64RegisterTpidr2El0         = 0x00040066,
...
typedef union WHV_X64_PENDING_VMX_NESTED_EXIT_EVENT3
{
    struct
    {
        UINT64 MsrData;
...
C_ASSERT(sizeof(WHV_X64_PENDING_VMX_NESTED_EXIT_EVENT3) == 16);
...
typedef union WHV_REGISTER_VALUE
{
    ...
    WHV_X64_PENDING_VMX_NESTED_EXIT_EVENT3 VmxNestedExit3;
#endif
} WHV_REGISTER_VALUE;
...
typedef enum WHV_CAPABILITY_CODE
{
    ...
    WHvCapabilityCodeMaxSmeStreamingVectorLength     = 0x00002013,
#endif
} WHV_CAPABILITY_CODE;
...
typedef union WHV_EXTENDED_VM_EXITS
{
    ...
    #define WHV_EXTENDED_VM_EXITS_RESERVED_BITFIELD_COUNT 49
    ...
    struct
    {
        ...
        UINT64 Reserved                   : WHV_EXTENDED_VM_EXITS_RESERVED_BITFIELD_COUNT;
    };
...
typedef union WHV_X64_PROCESSOR_FEATURES1
{
    struct
    {
        ...
        UINT64 Reserved18 : 1;
        UINT64 Reserved19 : 1;
        UINT64 LassSupport : 1;
        UINT64 IdleHltInterceptSupport : 1;
        UINT64 MsrListSupport : 1;
    };
...
typedef union WHV_ARM64_PROCESSOR_FEATURES1
{
    struct
    {
        ...
        UINT64 Ecv:1;           // ID_AA64MMFR0_EL1.ECV >= 0b0001
        UINT64 EcvPoff:1;       // ID_AA64MMFR0_EL1.ECV >= 0b0010
        ...
        UINT64 Gpa3:1;          // ID_AA64ISAR2_EL1.GPA3 == 0b0001
        UINT64 Apa3Base:1;      // ID_AA64ISAR2_EL1.APA3 == 0b0001, Only one APA3 bit may be set at once
        UINT64 Apa3Ep:1;        // ID_AA64ISAR2_EL1.APA3 == 0b0010, Only one APA3 bit may be set at once
        UINT64 Apa3Ep2:1;       // ID_AA64ISAR2_EL1.APA3 == 0b0011, Only one APA3 bit may be set at once
        UINT64 Apa3Ep2Fp:1;     // ID_AA64ISAR2_EL1.APA3 == 0b0100, Only one APA3 bit may be set at once
        UINT64 Apa3Ep2Fpc:1;    // ID_AA64ISAR2_EL1.APA3 == 0b0101, Only one APA3 bit may be set at once
        UINT64 Lrcpc3:1;        // ID_AA64ISAR1_EL1.LRCPC >= 0b0011
        UINT64 Sme:1;           // ID_AA64PFR1_EL1.SME >= 0b0001
        UINT64 SmeF32F32:1;     // ID_AA64PFR1_EL1.F32F32 >= 0b0001
        UINT64 SmeB16F32:1;     // ID_AA64PFR1_EL1.B16F32 >= 0b0001
        UINT64 SmeF16F32:1;     // ID_AA64PFR1_EL1.F16F32 >= 0b0001
        UINT64 SmeI8I32:1;      // ID_AA64PFR1_EL1.I8I32 >= 0b0001
        UINT64 SmeF64F64:1;     // ID_AA64PFR1_EL1.F64F64 >= 0b0001
        UINT64 SmeI16I64:1;     // ID_AA64PFR1_EL1.I16I64 >= 0b0001
        UINT64 Reserved:4;
    };
...
typedef union WHV_SYNTHETIC_PROCESSOR_FEATURES
{
    ...
    #define WHV_SYNTHETIC_PROCESSOR_FEATURES_RESERVED_BITFIELD_COUNT 18
    ...
    struct
    {
        ...
        // HvCallMapPartitionEventLogBuffer
        UINT64 ReservedZ45 : 1;

        UINT64 Reserved: WHV_SYNTHETIC_PROCESSOR_FEATURES_RESERVED_BITFIELD_COUNT;
    };
...
typedef union WHV_CAPABILITY
{
    ...
    UINT32 MaxSmeStreamingVectorLength;
#endif
} WHV_CAPABILITY;
...
C_ASSERT(TYPE_ALIGNMENT(WHV_RUN_VP_EXIT_CONTEXT) == 16);
C_ASSERT((FIELD_OFFSET(WHV_RUN_VP_EXIT_CONTEXT, MemoryAccess) % 16) == 0);
...
typedef enum WHV_VIRTUAL_PROCESSOR_STATE_TYPE
{
    ...
    WHvVirtualProcessorStateTypeSmeState                  = 0x00000008 | WHV_VIRTUAL_PROCESSOR_STATE_TYPE_PFN,
} WHV_VIRTUAL_PROCESSOR_STATE_TYPE;
...
//
// Data structure for WHvVirtualProcessorStateTypeSmeState
//

typedef struct WHV_ARM64_VP_STATE_SME {
    USHORT Version;
    USHORT RegisterDataOffset;
    UINT32 StreamingVectorLength;
    UINT64 Reserved0;
    // Starting at RegisterDataOffset:
    // ZA
} WHV_ARM64_VP_STATE_SME;
